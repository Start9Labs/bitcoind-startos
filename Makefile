...
ifeq ($(ARCH),x86_64)
	...
	docker buildx build --tag start9/$(PKG_ID)/main:$(PKG_VERSION) --build-arg ARCH=aarch64 --build-arg PLATFORM=arm64v8 --platform=linux/arm64 -o type=docker,dest=docker-images/aarch64.tar .
endif
