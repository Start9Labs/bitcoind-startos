...
export const configSpec = Config.of({
  ...
  peers: Value.object(
    ...
    Config.of({
      ...
      // TODO If onlyconnect is enabled addnode len should be min of 1
      ...
      // TODO update regex to allow port
                    ...
                    patterns: [
                      {
                        ...
                        description:
                          "Must be either a domain name, or an IPv4 or IPv6 address. Do not include protocol scheme (eg 'http://').",
                      },
                    ],
                    minLength: null,
                    maxLength: null,
